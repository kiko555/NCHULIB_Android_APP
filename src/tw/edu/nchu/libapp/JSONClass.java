...
public class JSONClass {
     ...
     *             No exceptions thrown
     */
    public HashMap<String, String> setTokenResultJSONtoDB(String TokenResultJSON,
            Context context) {
        /**
         * 
         */
        ...
        String strTokenResultJSON = TokenResultJSON;
        ...
        try {
            ...
            hmReturnResult.put("OpResult", new JSONObject(strTokenResultJSON)
                    .getJSONObject("Status").getString("OpResult"));
            hmReturnResult.put("OpInfo", new JSONObject(strTokenResultJSON)
                    .getJSONObject("Status").getString("OpInfo"));
            hmReturnResult.put("AuthResult", new JSONObject(strTokenResultJSON)
                    .getJSONObject("Status").getString("AuthResult"));
            hmReturnResult.put("AuthInfo", new JSONObject(strTokenResultJSON)
                    .getJSONObject("Status").getString("AuthInfo"));
            hmReturnResult.put("SysStatus", new JSONObject(strTokenResultJSON)
                    .getJSONObject("Status").getString("SysStatus"));
            hmReturnResult.put("SysInfo", new JSONObject(strTokenResultJSON)
                    .getJSONObject("Status").getString("SysInfo"));
            hmReturnResult.put("AppStableVersion", new JSONObject(strTokenResultJSON)
                    .getJSONObject("Status").getString("AppStableVersion"));
            ...
            if (hmReturnResult.get("AuthResult").equals("Success")) {
                ...
                jsonResultTitleArray = new JSONObject(strTokenResultJSON)
                        .getJSONObject("PatronLoan").getJSONArray("Z13_TITLE");
                jsonResultBarcodeArray = new JSONObject(strTokenResultJSON)
                        .getJSONObject("PatronLoan")
                        .getJSONArray("Z30_BARCODE");
                jsonResultDataTypeArray = new JSONObject(strTokenResultJSON)
                        .getJSONObject("PatronLoan").getJSONArray("DATA_TYPE");
                jsonResultEndDateArray = new JSONObject(strTokenResultJSON)
                        .getJSONObject("PatronLoan").getJSONArray("END_DATE");
            }
        } catch (JSONException e) {
            // 寫log
